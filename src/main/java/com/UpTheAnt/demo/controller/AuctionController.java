...
public class AuctionController {
    ...
    @ApiResponse(
        ...
        content = @Content(
            ...
            schema = @Schema(implementation = AuctionResponseDTO.class, type = "array"),
            examples = @ExampleObject(value = """
                [{
                  "name": "Пластинка",
                  "description": "Пластинка The Beatles",
                  "startPrice": 10000,
                  "currentBid": 1500,
    ...
    public AuctionResponseDTO createAuction(
        ...
        @RequestBody AuctionCreateDTO auctionCreateDTO,
    ...
    @ApiResponses({
        ...
        @ApiResponse(
            ...
            content = @Content(examples = @ExampleObject(value = """
                {
                  "error": "Auction not found with ID: 1"
                }
                """))
        ),
        @ApiResponse(
